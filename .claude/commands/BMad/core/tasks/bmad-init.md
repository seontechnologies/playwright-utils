...
<task id="bmad/core/tasks/bmad-init.md" name="BMAD Init">
  ...
  <flow>
    <step n="1" title="Welcome and Status Check">
      ...
      <action>Check for BMAD installation at /Users/murat.ozcan/seon/playwright-utils//bmad</action>
      <action>Display current version and installation date if available</action>
      <action>LOAD the manifest /Users/murat.ozcan/seon/playwright-utils//bmad/_cfg/manifest.xml</action>
      <format>
        ╔════════════════════════════════════════╗
        ║         BMAD INITIALIZATION            ║
        ╚════════════════════════════════════════╝
    ...
    <step n="3" title="Process User Selection">
      ...
      <conditions>
        <if option="1">
          ...
          <on-confirm>
            <action>Load and execute `/Users/murat.ozcan/seon/playwright-utils//bmad/core/tasks/agent-party-generate.md` task</action>
          </on-confirm>
        </if>
        <if option="2">
          <format>
  ...
  <validation>
    <check>Ensure BMAD is installed at /Users/murat.ozcan/seon/playwright-utils//bmad</check>
  ...
  <error-handling>
    <error type="no-installation">
      <message>BMAD installation not found at /Users/murat.ozcan/seon/playwright-utils//bmad</message>

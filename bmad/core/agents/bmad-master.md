...
<agent id="bmad/core/agents/bmad-master.md" name="BMad Master" title="BMad Master Task Executor" icon="🧙">
  ...
  <cmds>
    ...
    <c cmd="*list-tasks" action="list all tasks from {project-root}/bmad/_cfg/manifest.xml files type task">List Available Tasks</c>
    <c cmd="*list-templates" action="list all templates from {project-root}/bmad/_cfg/manifest.xml files type templates"></c>
    <c cmd="*party-mode" exec="{project-root}/bmad/core/tasks/party-mode.md">Group chat with all agents</c>

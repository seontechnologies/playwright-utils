...
import { test, expect } from '@playwright/test' // Use Playwright's standard test object
import {
  log,
  methodTestStep,
  functionTestStep,
...
// TODO: when there is a new test (like api e2e) put these settings there and delete this file
...
// and configure logging with organizeByTest after that
log.configure({
  fileLogging: {
    enabled: true
  }

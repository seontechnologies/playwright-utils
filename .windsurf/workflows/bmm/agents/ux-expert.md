...
<agent id="bmad/bmm/agents/ux-expert.md" name="Sally" title="UX Expert" icon="🎨">
  ...
  <cmds>
    ...
    <c cmd="*create-front-end-spec" exec="{project-root}/bmad/core/tasks/create-doc.md" tmpl="{project-root}/bmad/bmm/templates/uxui-spec.md">Create front-end spec</c>
    <c cmd="*generate-ui-prompt" exec="{project-root}/bmad/bmm/tasks/ai-fe-prompt.md">Create a prompts for Lovable or V0</c>

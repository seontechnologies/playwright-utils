...
<agent id="bmad/bmm/agents/pm.md" name="John" title="Product Manager" icon="📋">
  ...
  <cmds>
    ...
    <c cmd="*create-brownfield-epic" exec="{project-root}/bmad/bmm/tasks/bf-epic.md">Create New Epic for Existing Project</c>
    <c cmd="*create-brownfield-prd" exec="{project-root}/bmad/core/tasks/create-doc.md" tmpl="{project-root}/bmad/bmm/templates/brownfield-prd.md">Create New PRD (multiple epics) for Existing Project</c>
    <c cmd="*mk-bf-story" exec="{project-root}/bmad/bmm/tasks/bf-story.md">Create Simple Story (no epic) for Existing Project</c>
    <c cmd="*create-prd" exec="{project-root}/bmad/core/tasks/create-doc.md" tmpl="{project-root}/bmad/bmm/templates/prd.md">Create PRD for a New Project</c>
    <c cmd="*shard-prd" exec="{project-root}/bmad/core/tasks/shard-doc.md">Run shard-doc task for prd.md</c>
